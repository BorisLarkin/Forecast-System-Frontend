import {
  require_browser
} from "./chunk-ZQ2MW4MM.js";
import {
  require_picocolors_browser
} from "./chunk-52GSLGIW.js";
import {
  axios_default
} from "./chunk-4S4ZUAS3.js";
import "./chunk-UZRIV3JQ.js";
import {
  createLogger,
  require_node_child_process,
  require_node_crypto,
  require_node_util
} from "./chunk-QS4N7QTW.js";
...
// node_modules/vite-plugin-mkcert/dist/mkcert.mjs
...
function requestLog(octokit) {
  octokit.hook.wrap("request", (request3, options) => {
    ...
    return request3(options).then((response) => {
      octokit.log.info(
        `${requestOptions.method} ${path5} - ${response.status} in ${Date.now() - start}ms`
      );
      return response;
    }).catch((error) => {
      octokit.log.info(
        `${requestOptions.method} ${path5} - ${error.status} in ${Date.now() - start}ms`
      );
      throw error;
    });
  });
...
var Config = class {
  constructor({ savePath }) {
    ...
    this.configFilePath = import_node_path4.default.resolve(savePath, CONFIG_FILE_NAME);
  }
  async init() {
...
var request2 = axios_default.create();
...
var Record = class {
  ...
  getHosts() {
    var _a3;
    return (_a3 = this.config.getRecord()) == null ? void 0 : _a3.hosts;
  }
  getHash() {
    var _a3;
    return (_a3 = this.config.getRecord()) == null ? void 0 : _a3.hash;
  }
  contains(hosts) {
...
var GithubSource = class _GithubSource extends BaseSource {
  ...
  async getSourceInfo() {
    ...
    const downloadUrl = (_a3 = data.assets.find(
      (item) => item.name.includes(platformIdentifier)
    )) == null ? void 0 : _a3.browser_download_url;
...
var _a2;
var CodingSource = (_a2 = class extends BaseSource {
  static create() {
    return new _a2();
  }
  constructor() {
  ...
  async request(data) {
    return request_default({
      ...
      url: _a2.CODING_API,
      headers: {
        Authorization: _a2.CODING_AUTHORIZATION
      }
    });
  }
  /**
  ...
  async getSourceInfo() {
    ...
    const { data: VersionData } = await this.request({
      ...
      ProjectId: _a2.CODING_PROJECT_ID,
      Repository: _a2.REPOSITORY,
      Package: this.getPackageName(),
      PageSize: 1
    });
    const version = (_b = (_a3 = VersionData.Response.Data) == null ? void 0 : _a3.InstanceSet[0]) == null ? void 0 : _b.Version;
    if (!version) {
      return void 0;
    }
...
}, __publicField(_a2, "CODING_API", "https://e.coding.net/open-api"), __publicField(_a2, "CODING_AUTHORIZATION", "token 000f7831ec425079439b0f55f55c729c9280d66e"), __publicField(_a2, "CODING_PROJECT_ID", 8524617), __publicField(_a2, "REPOSITORY", "mkcert"), _a2);
...
var Mkcert = class _Mkcert {
  constructor(options) {
    ...
    __publicField(this, "savePath");
    __publicField(this, "logger");
    __publicField(this, "source");
    __publicField(this, "localMkcert");
    __publicField(this, "savedMkcert");
    __publicField(this, "keyFilePath");
    __publicField(this, "certFilePath");
    __publicField(this, "config");
    __publicField(this, "getLatestHash", async () => {
      return {
    ...
    this.savePath = import_node_path3.default.resolve(savePath);
    this.keyFilePath = import_node_path3.default.resolve(savePath, keyFileName);
    this.certFilePath = import_node_path3.default.resolve(savePath, certFileName);
    ...
    this.savedMkcert = import_node_path3.default.resolve(
      savePath,
  ...
  async retainExistedCA() {
    ...
    const caDirPath = import_node_path3.default.resolve(
...
//# sourceMappingURL=vite-plugin-mkcert.js.map
